class config:
    BOT_TOKEN = "1707736993:AAE26DjrONbhgYDgdGM0SwoXe5V0cXNJreo"
    APP_ID = "4011731"
    API_HASH = "3ffb306471f12a2037d6b9516c20c821"
    DATABASE_URL = ""
    SUDO_USERS = "650229581 1180849145" # Sepearted by space.
    SUPPORT_CHAT_LINK = ""
    DOWNLOAD_DIRECTORY = "/content/drive/Shareddrives/Web Development /@SKDriveUploaderBot/"
    G_DRIVE_CLIENT_ID = ""
